...
|---|---|---|
| Tres ciclos de cinco minutos | Tres `schedule` distintos, edad individual de datos y persistencia | FALLÓ la aceptación de apertura: cero eventos `schedule`; tres ciclos manuales pasaron, pero no la sustituyen |
